...
\textbf{R8F} & \begin{tabular}{@{}l@{}}L'utente può scaricare e/o caricare file dal/nel gruppo, a seconda \\ dei permessi garantiti dall'amministratore\end{tabular}\\

\textbf{R9F} & \begin{tabular}{@{}l@{}} È presente una sezione di personalizzazione in cui ogni utente può creare,  \\ a seconda delle sue preferenze, le sue view e può utilizzarale\end{tabular}
\\ 
