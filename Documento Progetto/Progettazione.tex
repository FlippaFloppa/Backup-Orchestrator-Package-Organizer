...
\end{itemize}
\phantomsection
\subsection*{L3 - Database e Storage}
...
\vspace{1cm}
\subsection*{Struttura Storage}
\phantomsection
\addcontentsline{toc}{subsection}{Struttura Storage}
\vspace{0.5cm}
\begin{adjustwidth}{-1cm}{0cm}
...
\section*{Deployment}
\vspace{1cm}
Per l'installazione dell' applicazione si richiede di avere predisposto i Server con il framework Dotnet, in modo da sfruttare il servizio Broker ".NET ASP".
\phantomsection
...
\vspace{0.5cm}
\begin{adjustwidth}{-2cm}{0cm}
\includegraphics[scale=0.8]{deployment/Diagramma-Sequenza-Artefatti.drawio.pdf}
\end{adjustwidth}
